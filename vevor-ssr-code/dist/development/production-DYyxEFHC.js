...
var register = require('./register-C9s_d7gV.js');
...
var require$$0$5 = require('querystring');
require('fs');
require('react');
...
function init(proxy, option) {
    ...
    logger$2.debug('[HPM] Subscribed to http-proxy events:', Object.keys(handlers));
}
_handlers.init = init;
    ...
    function rewritePath(path) {
        ...
        for (const rule of rulesCache) {
            if (rule.regex.test(path)) {
                ...
                logger$1.debug('[HPM] Rewriting path from "%s" to "%s"', path, result);
                break;
            }
        }
        return result;
...
(function (exports) {
	var __createBinding = (register.commonjsGlobal && register.commonjsGlobal.__createBinding) || (Object.create ? (function(o, m, k, k2) {
	...
	var __exportStar = (register.commonjsGlobal && register.commonjsGlobal.__exportStar) || function(m, exports) {
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return new Promise(function (resolve) {
            ...
            var proxyMiddleware = dist.createProxyMiddleware({
